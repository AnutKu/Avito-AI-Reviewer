<!-- Извлечено из Product-part/01_Входящие/homework_examples/system_design/лаба 2/хорошее.md скриптом api/scripts/extract_homework.py. Не редактировать вручную. -->

<!-- Извлечено из Product-part/01_Входящие/homework_examples/system_design/лаба 1/слабое_2.md скриптом api/scripts/extract_homework.py. Не редактировать вручную. -->

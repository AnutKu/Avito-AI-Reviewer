...
class Settings(BaseSettings):
    ...
    # Чем наполнять пустую базу: настоящим курсом из репозитория (по умолчанию)
    # или демонстрационным севом. Флаг здесь, а не в .env: это состояние
    # продукта, а не настройка окружения, и на новой машине кабинет обязан
    # подниматься одинаково без правки файлов.
    real_course_on_start: bool = True
